...
$_SETTINGS = [
	...
	"fromName"					=> "Garage Cars",					// From Name
	...
	"template"					=> "Hi,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>Ngày: {date}<br>Địa chỉ IP: {ip}<br><br>---<br>Have a nice day.",					// Mail Template
